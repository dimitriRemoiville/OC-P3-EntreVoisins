...
public class NeighbourServiceTest {
    ...
    public void getFavoritesNeighboursWithSuccess(){
        ...
        assertTrue(favoritesNeighbours.contains(neighbours.get(0)));
    }
    ...
    public void deleteNeighbourFromFavoritesWithSuccess(){
        ...
        for (Neighbour n: neighbours) {
            service.addFavoriteNeighbour(n);
        }
        service.deleteFavoriteNeighbour(neighbours.get(0));
        List<Neighbour> favoritesNeighbours = service.getFavoritesNeighbours();
        assertFalse(favoritesNeighbours.contains(neighbours.get(0)));
    }
}
